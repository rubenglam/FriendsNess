...
const WorkoutExerciceSchema = require('../models/workout-exercice.model');

const getWorkoutExercices = async (req = request, res = response) => {
	const id = req.params.id;

	try {
		// Coger todos los workout exercices de un workout
		const workoutExercices = WorkoutExerciceSchema.find({ workout: id }).populate('WorkoutExerciceSet');
