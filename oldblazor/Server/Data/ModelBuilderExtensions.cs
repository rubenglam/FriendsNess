    ...
    public static class ModelBuilderExtensions
    {
        private static readonly IEnumerable<Exercice> _exercices = new List<Exercice>()
        {
            new Exercice()
            {
                ...
                ExercicedBodyParts = BodyPart.Chest
            },
            new Exercice()
            {
                Id = 2,
                Name = "Squat",
                Category = ExerciceCategory.Barbell,
                ExercicedBodyParts = BodyPart.Legs
            },
            new Exercice()
            {
                Id = 3,
                Name = "Deadlift",
                Category = ExerciceCategory.Barbell,
                ExercicedBodyParts = BodyPart.WholeBody
            },
            new Exercice()
            {
                Id = 4,
                Name = "Shoulder Press",
                Category = ExerciceCategory.Barbell,
                ExercicedBodyParts = BodyPart.Shoulders
            },
            new Exercice()
            {
                Id = 5,
                ...
                ExercicedBodyParts = BodyPart.Back
            },
            new Exercice()
            {
                Id = 6,
            ...
            new Exercice()
            {
                ...
                Name = "Dumbbell Curl",
                Category = ExerciceCategory.Dumbbell,
                ExercicedBodyParts = BodyPart.Biceps
            },
            new Exercice()
            {
                Id = 8,
            ...
            new Exercice()
            {
                ...
                Name = "Dips",
                Category = ExerciceCategory.Bodyweight,
                ExercicedBodyParts = BodyPart.Triceps
            },
            new Exercice()
            {
                Id = 15,
            ...
            new Exercice()
            {
                ...
                Name = "Sit Ups",
                Category = ExerciceCategory.Bodyweight,
                ExercicedBodyParts = BodyPart.Core
            },
            new Exercice()
            {
                Id = 68,
